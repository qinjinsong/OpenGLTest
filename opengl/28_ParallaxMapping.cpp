...
//	
//	Shader shader("glsl/vParallaxMapping.glsl", "glsl/fParallaxMapping.glsl");
//	
//	GLuint diffuseMap = loadTexture("texture/wood.png");
//	GLuint normalMap = loadTexture("texture/toy_box_normal.png");
//	GLuint heightMap = loadTexture("texture/toy_box_disp.png");
//
//	shader.Use();
