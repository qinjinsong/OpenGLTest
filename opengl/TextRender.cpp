...
//	
//	Shader shader("glsl/vText.glsl", "glsl/fText.glsl");
...
//
//		renderText(shader, "abcdefgfjAAAVVEFEWafeojo;faj12304898 >,[]?!@#$%^&*()-+", 0.0f, 0.0f, 0.5f, glm::vec3(0.5, 0.8f, 0.2f));
...
////	// Load font as face
////	FT_Face face;
////	if (FT_New_Face(ft, "font/SIMHEI.ttf", 0, &face))
