...
//		//lightingShader.SetFloat3("light.ambient", ambientColor.x, ambientColor.y, ambientColor.z);
...
//
//		// 11_Material_t1
//		lightingShader.SetFloat3("light.ambient", 1.0f, 1.0f, 1.0f);
//		lightingShader.SetFloat3("light.diffuse", 1.0f, 1.0f, 1.0f);
//		lightingShader.SetFloat3("light.specular", 1.0f, 1.0f, 1.0f);
//		//set material properties
//		lightingShader.SetFloat3("material.ambient", 0.0f, 0.1f, 0.06f);
//		lightingShader.SetFloat3("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
//		lightingShader.SetFloat3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
//		lightingShader.SetFloat("material.shininess", 32.0f);
//
//		glm::mat4 view;
