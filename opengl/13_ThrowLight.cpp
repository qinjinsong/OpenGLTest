...
//		lightingShader.SetFloat3("light.position", camera.position.x, camera.position.y, camera.position.z);
//		lightingShader.SetFloat3("light.direction", camera.front.x, camera.front.y, camera.front.z);
...
//		lightingShader.SetFloat3("light.ambient", 0.1f, 0.1f, 0.1f);
//		lightingShader.SetFloat3("light.diffuse", 0.8f, 0.8f, 0.8f);
