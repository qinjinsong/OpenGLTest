...
//		transform1 = glm::rotate(transform1, (GLfloat)glfwGetTime(), glm::vec3(0.0f, 0.0f, 1.0f));
...
//		GLfloat scaleOffset = sin(glfwGetTime());
//		//GLfloat scaleOffset = sin(glfwGetTime()) * 0.5f + 0.5f;
//		transform2 = glm::scale(transform2, glm::vec3(scaleOffset, scaleOffset, scaleOffset));
//		transform2 = glm::rotate(transform2, -(GLfloat)glfwGetTime(), glm::vec3(0.0f, 0.0f, 1.0f));
